...
const Navbar = () => {
  ...
  return (
    ...
    ${isScroll ? "bg-opacity-50 backdrop-blur-lg shadow-sm": ""}`}>
        <a href="#top">
            <Image src={assets.logo} alt="logo" width="500" height="500" className='w-28
        ...
        <div className='flex items-center gap-4'>
            <button>
                <Image src={assets.moon_icon} alt="moon_icon" className='w-6 cursor-pointer'/>
            </button>
            ...
            <button className='block md:hidden ml-3' onClick={openMenu}>
                <Image src={assets.menu_black} alt="menu_black" className='w-6 cursor-pointer'/>
            </button>
        </div>
