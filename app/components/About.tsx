...
const About = ({isDarkMode} : any) => {
  return (
    <motion.div id='about' className='w-full px-[12%] py-20
    scroll-mt-20'
    initial={{opacity: 0}}
    ...
    >
        ...
        className='flex w-full flex-col lg:flex-row items-center gap-20 my-10'>
            ...
            className='flex-1'>
            <p className='mx-auto mb-8 max-w-2xl font-Ovo'> 
                ...
                max-w-2xl'>
                    ...
                    (
                        ...
                        p-6 cursor-pointer hover:bg-[#fcf4ff] hover:-translate-y-1 duration-500 
                        hover:shadow-[4px_4px_0_#000] dark-border-white hover-shadow-white
                        hover-dark-hover-50'>
