...
const Services = ({isDarkMode} : any) => {
  return (
    ...
    id="services" className='w-full px-[12%] py-20 scroll-mt-20'>
        ...
        I offer full-stack web development, AI integration, and custom solutions to help businesses 
        and individuals build innovative, user-friendly applications
        </motion.p>
        ...
        className='grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-6 my-10'>
            {serviceData.map(({icon, title, description, link}, index) => (
                ...
                hover:-translate-y-1 duration-500 hover-dark-hover
                hover-shadow-white'>
